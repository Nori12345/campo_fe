...
<body>
   <!--  <img class="wave"src="../assets/img/wave.png" alt="">  -->
    ...
    <div class="img">
    <img src="assets/img/logo-campofe.png" alt="">
    </div>
    <div class="contenido-login">

    <form autocomplete="off" method="POST"  role="form">

    <img src="assets/img/favicon-campofe.ico" alt="">
    <h2>Acceso</h2>
    <?php
    if(isset($errMsg)){
...
?>
    ...
    <button class="btn" name='login' type="submit"> Iniciar sesión
    </button> 
